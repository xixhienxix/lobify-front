...
@Component({
    ...
    selector: 'app-fare-calendar',
    templateUrl: 'fare.calendar.component.html',
    styleUrls: ['fare.calendar.component.scss'],
    encapsulation: ViewEncapsulation.None,
    providers: [MonthService],
})

export class FareCalendarComponent {
  ...
  public onChange(args: ChangeEventArgs): void {
    ...
    const scheduleData: Record<string, any>[] = extend([], this.dManager, undefined, true) as Record<string, any>[];
  ...
  public generateEvents(scheduleObj: Schedule): Record<string, any>[] {
    ...
    this.dManager = extend([], collections, undefined, true) as Record<string, any>[];
