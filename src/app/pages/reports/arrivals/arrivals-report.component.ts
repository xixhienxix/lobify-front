...
@Component({
    selector:'app-arrivals-report',
    templateUrl:'./arrivals-report.component.html',
    styleUrls:['./arrivals-report.component.scss'],
    encapsulation:ViewEncapsulation.None
})
export class ArrivalsReportComponent implements OnInit {
